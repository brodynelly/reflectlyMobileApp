/*
  # Complete Program Exercises Migration

  1. Tables
    - Drop and recreate programs table with correct schema
    - Drop and recreate program_exercises table with correct schema
    - Drop and recreate user_program_progress table with correct schema
  ...
  3. Data
    ...
    - Insert complete set of exercises for each program
*/
...
-- Insert program exercises for Self-Love Journey
...
-- Insert program exercises for Anxiety Toolkit
INSERT INTO program_exercises (program_id, title, instructions, estimated_minutes, exercise_type, day_number, order_number)
VALUES
...
-- Insert program exercises for Inner Peace Journey
INSERT INTO program_exercises (program_id, title, instructions, estimated_minutes, exercise_type, day_number, order_number)
VALUES
...
-- Insert program exercises for Emotional Balance (14-day program)
INSERT INTO program_exercises (program_id, title, instructions, estimated_minutes, exercise_type, day_number, order_number)
VALUES
